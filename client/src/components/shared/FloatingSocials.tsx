    ...
    <StyledWrapper className="fixed right-0 top-1/2 -translate-y-1/2 z-[9999]">
      <ul className="example-2">
        ...
        <li className="icon-content">
          <a href="https://www.facebook.com/profile.php?id=61592901971612" target="_blank" rel="noopener noreferrer" aria-label="Facebook" data-social="facebook">
        ...
        {/* Youtube */}
        <li className="icon-content">
          <a href="https://www.youtube.com/@BiharDarshanOfficial2026" target="_blank" rel="noopener noreferrer" aria-label="Youtube" data-social="youtube">
            <div className="filled" />
        ...
        {/* Instagram */}
        <li className="icon-content">
          <a href="https://www.instagram.com/bihar_darshanofficial/" target="_blank" rel="noopener noreferrer" aria-label="Instagram" data-social="instagram">
            <div className="filled" />
        ...
        {/* Gmail */}
        <li className="icon-content">
          <a href="mailto:bihardarshanofficial@gmail.com" aria-label="Gmail" data-social="gmail">
            <div className="filled" />
