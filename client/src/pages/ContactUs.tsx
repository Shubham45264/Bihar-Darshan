...
const ContactUs = () => {
  ...
  return (
    <div className="min-h-screen bg-[#FAF9F6] text-[#4A3728] font-sans pb-10">
      ...
      {/* --- HERO SECTION --- */}
      <section className="relative flex flex-col lg:flex-row items-center overflow-hidden pt-20">
        ...
        {/* Hero Image - Referencing public/contact-hero.png with fallback */}
        <div className="w-full lg:w-1/2 h-[400px] lg:h-[80vh] relative">
          <img 
            ...
            onError={(e) => {
              (e.target as HTMLImageElement).src = biharHeritage;
            }}
          />
...
const FormInput: React.FC<FormInputProps> = ({ icon, placeholder }) => (
  <div className="relative">
